...
function populateConnectionModalResults(a){$("#connection-search-results").html("");$("#connection-loader").hide();if(a.albums){for(var b=0;b<a.albums.length;b++){var c=a.albums[b],d=b+1;createConnectionModalCard(c,d);populateConnectionModalCard(c,d)}createConnectionModalCard(a.albums.length+1)}}
