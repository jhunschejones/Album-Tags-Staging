...
function populateAlbumPage(a){populateTags();populateConnections();getUserLists();a?(updateTagDisplay(a),updateConnectionDisplay(a),populateListsWithAlbum(a)):(0===document.getElementsByClassName("album-tag").length&&document.getElementById("current-tags").appendChild(stringToNode('<div class="text-primary text-center"><small>There are currently no tags for this album. Log in to start adding your own tags!</small></div>')),0===document.getElementsByClassName("connection").length&&document.getElementById("connected-albums").appendChild(stringToNode('<div class="text-primary text-center"><small>There are currently no connections for this album. Log in to start adding your own connections!</small><br/><br/></div>')),
0===document.getElementsByClassName("list").length&&(removeSelectedElement(".list-message"),document.getElementById("all-lists").appendChild(stringToNode('<div class="text-primary text-center list-message"><small>This album is not in any public user lists yet. Log in to get started working with lists!</small><br/><br/></div>'))))}
...
function populateListsWithAlbum(a){console.log("populating lists");document.getElementById("all-lists").innerHTML="";removeSelectedElement(".list-message");app.userID&&app.album.favorites&&app.album.favorites.find(function(a){return a.userID===app.userID})&&document.getElementById("all-lists").appendChild(stringToNode('<li class="list my-list" data-creator="'+app.userID+'"><a href="/list?type=myfavorites">&#9825; My Favorites</a><span class="text-secondary"> by: You!</span><span class="remove-from-list-button" data-list-type="myfavorites">&#10005;</span></li>'));
