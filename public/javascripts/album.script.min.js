...
$("#new-display-name").val("")):60<a.length?alert("List titles must be shorter than 60 characters in length."):30<b.length?alert("Display names must be shorter than 30 characters in length."):(addToNewList(escapeHtml(a),escapeHtml(b)),document.getElementById("new-display-name").value="",document.getElementById("new-list-title").value=""):alert("All lists require a title!")});$("#custom-genre-checkbox-text").click(function(a){a.preventDefault();$("#custom-genre-checkbox").click()});
