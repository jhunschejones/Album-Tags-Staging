...
function getAlbumDetails(a){$.ajax("/api/v1/album/"+albumID,{method:"GET",success:function(b){albumResult=b;populateAlbumPage(a)},error:function(b){"No album found"===JSON.parse(b.responseText).message.slice(0,14)?$.getJSON("/api/v1/apple/details/"+albumID,function(b){b.message?alert(b.message):(albumResult=b,populateAlbumPage(a))}):console.log(b)}})}
...
function checkUserFavorites(a){userID&&$.ajax({method:"GET",url:"/api/v1/favorite/"+userID,success:function(b){albumResult.favorited=!!b.find(function(a){return a.appleAlbumID===albumResult.appleAlbumID});populateListsWithAlbum(a)}})}
...
function getConnections(){$.ajax("/api/v1/connection/"+albumResult.appleAlbumID,{method:"GET",contentType:"application/json",success:function(a){albumResult.connectionObjects=a;populateConnections();updateConnectionDisplay()},error:function(a){"This user has not created any connections for this album."===a.responseJSON.message&&(albumResult.connectionObjects=[],populateConnections(),updateConnectionDisplay())}})}
