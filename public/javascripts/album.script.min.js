...
a.user+'"><a href="/list?type=userlist&id='+a._id+'">'+a.title+'</a><span class="text-secondary"> by: '+b+"</span></li>")}});$(".remove-from-list-button").click(function(a){a.preventDefault();removeFromList($(this).data("list-id"))});a?updateListDisplay():0===$(".list").length&&($(".list-message").remove(),$("#all-lists").after('<div class="text-primary text-center list-message"><small>This album is not in any public user lists yet. Log in to get started working with lists!</small><br/><br/></div>'))}
