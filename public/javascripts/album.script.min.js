...
$("#current-tags").html('<div id="no-all-tags" class="text-primary text-center"><small>There are currently no tags for this album. Click "Add tags" below to get started!</small></div>');a&&$("#show-all-tags").click(function(b){b.preventDefault();sessionStorage.setItem("tags","My Tags");updateTagDisplay(a)})}
