...
function addInfoButtons(){$("#compact_menu p").width("80%");$("#compact_menu p").css("margin-top","-9px");$(".my_dropdown").css("margin-top","-2px");$("#compact_menu p").append('<span class="text-secondary ml-2 mr-1" style="cursor:pointer;font-size:1.4em;" data-toggle="modal" data-target="#addFavoritesAlbumModal">&plus;</span>');$("#compact_menu p").append('<span class="text-secondary ml-2 float-right page-info-button" style="cursor:pointer;margin-top:8px;" data-toggle="modal" data-target="#pageInfoModal">&#9432;</span>');
