...
document.getElementById("get-shareable-link").addEventListener("click",function(){var a=$("#display-name-input").val();$.ajax("/api/v1/list/favorites/"+userID,{method:"POST",contentType:"application/json",data:JSON.stringify({displayName:a}),success:function(a){a=window.location.protocol+"//"+window.location.host+"/list/"+a;var b=document.getElementById("shareable-url");b.value=a;b.select();navigator.clipboard.writeText(a).then(function(){$("#copied-message").show();setTimeout(function(){$("#copied-message").hide()},
