...
$(".albumCard");startTags()}}function removeFromFavorites(a){var b=myFavoriteAlbums.find(function(b){return b._id===a});confirm('Are you sure you want to remove "'+b.title+'" from your favorites? You cannot undo this operation.')&&$.ajax("/api/v1/album/favorites/"+a,{method:"DELETE",contentType:"application/json",data:JSON.stringify({user:userID}),success:function(a){a.message?alert(a.message):(removeElementFromArray(myFavoriteAlbums,b),startFavoritesPage())}})}
