...
$("#all-favorites-filters").append('<button class="btn btn-sm btn-light sticky-top float-left button_text ml-1" style="cursor:pointer;margin-top:2px;" data-toggle="modal" data-target="#addFavoritesAlbumModal">Add Album</button>');$("#all-favorites-filters").append('<button class="btn btn-sm btn-light sticky-top float-left button_text ml-1" style="cursor:pointer;margin-top:2px;" data-toggle="modal" data-target="#pageInfoModal">&#9432;</button>')}addInfoButtons();
$(".add-album-instruction-link").click(function(a){a.preventDefault();$("#pageInfoModal").modal("hide");$("#addFavoritesAlbumModal").modal("show")});$(document).ready(function(){var a=!1;"ontouchstart"in document.documentElement&&(a=!0);a&&(a=document.getElementById("favorites-search-results"),a.style.paddingBottom="0px",a.style.overflowX="scroll")});
