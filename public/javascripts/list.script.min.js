...
32):a)+"</span>")});$(".artist-filter").click(function(a){a.preventDefault();toggleFilter("artist",$(this).data("artist"))});var e=[];a.forEach(function(a){a.genres&&a.genres.forEach(function(a){isGenre(a)?addToArray(e,a):console.log("Ignored genre: '"+a+"'")})});e.sort();e.forEach(function(a){b.genre&&a===b.genre?$("#genre-filter-dropdown").append('<span class="badge badge-primary genre-filter" data-genre="'+a+'">'+a+"</span>"):$("#genre-filter-dropdown").append('<span class="badge badge-light genre-filter" data-genre="'+
a+'">'+a+"</span>")});$(".genre-filter").click(function(a){a.preventDefault();toggleFilter("genre",$(this).data("genre"))})}}function toggleFilter(a,b){var c=new URL(document.location);c.searchParams.get(a)==b?c.searchParams.delete(a):c.searchParams.set(a,b);history.pushState({},"",c);populateList()}function clearFilters(){var a=new URL(document.location);a.searchParams.delete("year");a.searchParams.delete("artist");a.searchParams.delete("genre");history.pushState({},"",a);populateList()}$("#clear-filters-button").click(clearFilters);
