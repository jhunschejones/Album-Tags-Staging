...
window.location.href="/list/"+a.$jscomp$loop$prop$list$2._id}}(a))}$(".list-delete-button").on("click",function(a){a.preventDefault();removeList($(this).attr("data-list-id"))})}else $("#no-lists-message").show()}
...
$("#main-page-loader").hide(),$("#login-message").show(),$("#page-title").hide(),$("#all-lists").hide())});var userID;
